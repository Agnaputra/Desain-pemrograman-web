...
// Create data if the form is submitted via POST
...
// Delete data if the "delete" action is triggered via GET
...
<body>
    <div class="container mt-5">
        ...
        <button class="btn btn-success" data-toggle="modal" data-target="#tambahModal">Tambah Jabatan</button>

    </div>

    <!-- Modal to add new Jabatan data -->
